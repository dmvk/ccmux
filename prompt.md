...
If tasks introduces new build tooling, that could serve as automatic feedback loop, note how to execute it into @feedback.md for future iterations.

# FEEDBACK LOOPS

Before committing, run the feedback loop described in @feedback.md.
